...
- an ESP32-C3-zero board in the board2 position (with jst connector room)
- an ESP32-c3-zero board (or similar) in the board3 position
There  are 2 wago rows 
"""
...
config = Config (
    ...
    board2 = Board("top", # esp32-c3-zero
                   board_width=18,
                   length=24,
                   thickness=2.0,
                   usb_height = 1.8, 
